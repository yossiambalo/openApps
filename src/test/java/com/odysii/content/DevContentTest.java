...
public class DevContentTest extends TestBase {
   ...
   @Test
    ...
    public void _014_my_apps_add_new_app_valid_text_retailers() {
        ...
        String actualRtlOpt3 = RtlDrpDwn.findElements(By.className("multiselect-item-checkbox")).get(1).getText().trim();
        Assert.assertEquals(actualRtlOpt3,expectedRtlOpt3);
        String expectedRtlOpt4 = "Odysii";
        String actualRtlOpt4 = RtlDrpDwn.findElements(By.className("multiselect-item-checkbox")).get(2).getText().trim();

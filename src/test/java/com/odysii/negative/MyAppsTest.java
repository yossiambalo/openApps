...
public class MyAppsTest extends TestBase {
    ...
    public void _001_name_field_is_empty_negative() {
        ...
        appDetails.setUpAppDetails("","1.2.5","Subtitle",PriceType.PER_SITE_PER_YEAR,"3",AvailabilityType.PUBLIC,false,false);
    ...
    public void _002_subtitle_field_is_empty_negative() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("Roi", "1.0.2","", PriceType.ON_TIME_FLAT_FEE, "5", AvailabilityType.PUBLIC,false,false);
        Boolean actualValue = isElementExist(By.className("custom-file-input"));
    ...
    public void _003_language_is_empty_negative() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("Yossi","1.0.2", "Arau", CategoryType.SPORTS, "6",AvailabilityType.PRIVATE,false,false);
        Boolean actualValue = isElementExist(By.className("custom-file-input"));
    ...
    public void _004_category_is_empty_negative() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("Liron","1.0.2", "IT", PriceType.PER_DISPENSER_PER_YEAR,"3",AvailabilityType.PRIVATE,false,false);
        Boolean actualValue = isElementExist(By.className("custom-file-input"));
    ...
    public void _005_availability_is_empty_negative() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("XXX","1.0.2", "PP",PriceType.PER_DISPENSER_PER_MONTH,"4",null,false,false);
        Boolean actualValue = isElementExist(By.className("custom-file-input"));
    ...
    public void _011_valid_name_field_special_chars_negative() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("@!*#$%!","1.0.2", "+-/*",PriceType.ON_TIME_FLAT_FEE,"77",AvailabilityType.PUBLIC,false,false);
    ...
    public void _013_language_input_name_field_chinese_128_chars_positive() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对品卞光郎竹彡助断对断对","1.0.2", "Max is 256 chars",PriceType.PER_DISPENSER_PER_YEAR,"66",AvailabilityType.PRIVATE,false,false);
        Boolean actualValue = isElementExist(By.className("custom-file-input"));
    ...
    public void _014_language_input_subtitle_field_hebrew_128_chars_positive() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("hebrew test","1.0.2", "אני כותב טקסט בעברית... פםדחגפסךןקג]םח ]םחקגךלמאני כותב טקסט בעברית... פםדחגפסךןקג]םח ]םחקגךלמאני כותב טקסט בעברית... פםדחגפסךן",PriceType.PER_SITE_PER_YEAR,"3",AvailabilityType.PRIVATE,false,false);
        Boolean actualValue = isElementExist(By.className("custom-file-input"));
    ...
    public void _015_back_button_upload_code(){
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("test","1.0.2", "scvs",PriceType.PER_DISPENSER_PER_YEAR,"3",AvailabilityType.PRIVATE,false,false);
    ...
    public void _016_cancel_button_upload_code_page() {
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        appDetails.setUpAppDetails("test2","1.0.2", "scdvdvs", PriceType.PER_DISPENSER_PER_YEAR,"3",AvailabilityType.PRIVATE,false,false);
    ...
    public void _017_continue_button_upload_code_page_positive(){
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        Dependencies dependencies= appDetails.setUpAppDetails("Test Button Upload Code Positive","8.8.18","YNWA",PriceType.PER_DISPENSER_PER_MONTH,"8",AvailabilityType.PRIVATE,false,false);
        wait(WAIT);
...
//        WebElement agreeAndUpload = driver.findElement(By.id("codeFile"));
    ...
    public void _018_promotional_text_empty_marketing_page_negative(){
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        Dependencies dependencies = appDetails.setUpAppDetails("Kadlj","1.0.2","sss",PriceType.PER_SITE_PER_YEAR,"32",AvailabilityType.PRIVATE,false,false);
        wait(WAIT);
        UploadCode uploadCode = dependencies.clickOnNextButton();
        marketing = uploadCode.upload(zipFile, true);
        wait(WAIT);
    ...
    public void _022_manifest_version_conflict(){
        ...
        Dependencies dependencies = appDetails.setUpAppDetails(uniqueName,"5.5", "Sub",PriceType.PER_SITE_PER_YEAR, "2",AvailabilityType.PRIVATE,false,false);
        wait(WAIT);
        UploadCode uploadCode = dependencies.clickOnNextButton();
        marketing = uploadCode.upload(zipFile,true);
        wait(WAIT);
    ...
    public void _023_manifest_name_conflict() {
        ...
        wait(WAIT);
        appDetails = myApps.clickAddNewAppBtn();
        Dependencies dependencies1 = appDetails.setUpAppDetails(uniqueName, "5.5", "Sub", PriceType.PER_SITE_PER_YEAR, "2", AvailabilityType.PRIVATE,false,false);
        wait(WAIT);
    ...
    public void _024_right_version_display_after_conflict_from_manifest(){
        ...
        Dependencies dependencies = appDetails.setUpAppDetails(uniqueName,"10","sub", PriceType.PER_DISPENSER_PER_MONTH, "22",AvailabilityType.PRIVATE,false,false);
        wait(WAIT);
        UploadCode uploadCode = dependencies.clickOnNextButton();
        marketing = uploadCode.upload(zipFile, true);
        marketing.fillMarketing("ww","dd","72-72.jpg","app1.jpg",true);
        ...
        String expectedValue = uploadCode.getNewVersionFromManifest();
        String actualValue = driver.findElement(By.className("text-medium-title")).getText();
    ...
    public void _025_upload_zip_without_name_after_name_conflict(){
        MyApps myApps = devUser.getMyAppsPage(driver);
        appDetails = myApps.clickAddNewAppBtn();
        Dependencies dependencies = appDetails.setUpAppDetails("d","3","dd0",PriceType.PER_SITE_PER_YEAR, "44",AvailabilityType.PRIVATE,false,false);
        UploadCode uploadCode = dependencies.clickOnNextButton();
        marketing = uploadCode.upload(zipFile,true);
        wait(WAIT);
